...
|-----------|--------|----------|
| [Server + CLI](mstore/server/) | v0.3.0 | [Linux amd64](https://github.com/moreum-tech/MBox/releases/download/mstore-v0.3.0/mstore-linux-amd64.tar.gz) |
| [Docker](mstore/docker/) | v0.3.0 | [Image](https://github.com/moreum-tech/MBox/releases/download/mstore-v0.3.0/mstore-docker.tar.gz) |
