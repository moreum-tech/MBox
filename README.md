...
| Component | Latest | Download |
|-----------|--------|----------|
| [API Server](digimr/api/) | v2.2.1 | [Linux amd64](https://github.com/moreum-tech/MBox/releases/download/digimr-v2.2.1/digimr-linux-amd64.tar.gz) |
| [Docker](digimr/docker/) | v2.2.1 | [Image](https://github.com/moreum-tech/MBox/releases/download/digimr-v2.2.1/digimr-docker.tar.gz) |
