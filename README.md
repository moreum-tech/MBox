...
| Component | Latest | Download |
|-----------|--------|----------|
| [API Server](digimr/api/) | v1.1.0 | [Linux amd64](https://github.com/moreum-tech/MBox/releases/download/digimr-v1.1.0/digimr-linux-amd64.tar.gz) |
| [Docker](digimr/docker/) | v1.1.0 | [Image](https://github.com/moreum-tech/MBox/releases/download/digimr-v1.1.0/digimr-docker.tar.gz) |
| [Java SDK](https://github.com/moreum-tech/MBox/releases/download/digimr-v1.1.0/digimr-sdk-1.0.0-all.jar) | 1.0.0 | JAR |
