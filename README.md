...
| Component | Latest | Download |
|-----------|--------|----------|
| [API Server](digimr/api/) | v2.2.0 | [Linux amd64](https://github.com/moreum-tech/MBox/releases/download/digimr-v2.2.0/digimr-linux-amd64.tar.gz) |
| [Docker](digimr/docker/) | v2.2.0 | [Image](https://github.com/moreum-tech/MBox/releases/download/digimr-v2.2.0/digimr-docker.tar.gz) |
