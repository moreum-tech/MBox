...
**Dokumantasyon:** [mstore/docs/](mstore/docs/) — kurulum, yapilandirma, S3 ve gRPC API, SDK referansi. Okumak icin kurulum gerekmez.
...
| Bilesen | Son Surum | Indir |
|---------|-----------|-------|
| [API Sunucu](digimr/api/) | v2.3.1 | [Linux amd64](https://github.com/moreum-tech/MBox/releases/download/digimr-v2.3.1/digimr-linux-amd64.tar.gz) |
| [Docker](digimr/docker/) | v2.3.1 | [Imaj](https://github.com/moreum-tech/MBox/releases/download/digimr-v2.3.1/digimr-docker.tar.gz) |
| [Java SDK](https://github.com/moreum-tech/MBox/releases/download/digimr-v2.3.1/digimr-sdk-1.0.0-all.jar) | 1.0.0 | JAR |

**Dokumantasyon:** [digimr/docs/](digimr/docs/) — kurulum rehberi, REST API referansi, .NET SDK referansi, imza formatlari. Okumak icin kurulum gerekmez.
