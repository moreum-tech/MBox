...
| Bilesen | Son Surum | Indir |
|---------|-----------|-------|
| [API Sunucu](digimr/api/) | v2.1.0 | [Linux amd64](https://github.com/moreum-tech/MBox/releases/download/digimr-v2.1.0/digimr-linux-amd64.tar.gz) |
| [Docker](digimr/docker/) | v2.1.0 | [Imaj](https://github.com/moreum-tech/MBox/releases/download/digimr-v2.1.0/digimr-docker.tar.gz) |
