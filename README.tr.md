...
| Bilesen | Son Surum | Indir |
|---------|-----------|-------|
| [API Sunucu](digimr/api/) | v2.0.1 | [Linux amd64](https://github.com/moreum-tech/MBox/releases/download/digimr-v2.0.1/digimr-linux-amd64.tar.gz) |
| [Docker](digimr/docker/) | v2.0.1 | [Imaj](https://github.com/moreum-tech/MBox/releases/download/digimr-v2.0.1/digimr-docker.tar.gz) |
