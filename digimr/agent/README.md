...
The Token Agent binary is included in the [API server package](https://github.com/moreum-tech/MBox/releases/download/digimr-v2.2.0/digimr-linux-amd64.tar.gz).
