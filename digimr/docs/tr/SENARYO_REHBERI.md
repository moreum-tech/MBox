...
│   │   ├── .NET projesi mi? ────────────────────► SDK: SignDataWithProviderAsync
...
│   │   └── SDK: CreateEypPackageV20Async (2.0) / V21Async (2.1)
...
│
├── Guvenlik kodu? (EYP 2.x — gecerli kodlar: YOK/HZO/OZL/GZL/CGZ; V1.3: TSD/HZO/OZL/GZL/CGZ/KSO)
│   ├── Genel erisim (yok) ────────────────────► GuvenlikKodu: "YOK"
│   ├── Hizmete ozel ──────────────────────────► GuvenlikKodu: "HZO"
│   ├── Ozel ──────────────────────────────────► GuvenlikKodu: "OZL"
│   ├── Gizli ─────────────────────────────────► GuvenlikKodu: "GZL"
│   └── Cok gizli ─────────────────────────────► GuvenlikKodu: "CGZ"
│
...
*API referansi: [API_REFERANS.md](API_REFERANS.md)*
