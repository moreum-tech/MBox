...
|----------|---------|------|-------|------|-------|
| EYP 1.3 | OPC (ECMA-376) | P4 CAdES-A (B-LTA) default; P3/P4 CAdES-X Long opt-in | P4 CAdES-A (B-LTA) default | SHA-256 | ✅ Desteklenir |
| EYP 2.0 | OPC (ECMA-376) | CAdES P4 X-Long (B-LT) | Zorunlu P4 CAdES-A (B-LTA) | SHA-256 + SHA-512 | ✅ Desteklenir |
| EYP 2.1 | OPC (ECMA-376) | CAdES P4 X-Long (istisnai 6 kurum için P3) | Zorunlu P4 CAdES-A | SHA-256 + SHA-512 | ✅ Desteklenir |

**V2.1 ek yetenekler**:
- **Güncelleme Paketi** (§6.2.4): Orijinal paketi değiştirmeden dış OPC kabında gizlilik derecesi değişikliği gibi meta değişiklikleri barındırır.
- **Paraf İmza** (§5.2.1.6): Hazırlayan/paraflayan akışı; ana imza ve mühürün yanında opsiyonel ParafOzeti + ParafImzaCades.
- **P3 istisnası** (§3): TSK, Jandarma, Sahil Güvenlik, MİT, EGM, Dışişleri için P3 X-Long imza kabul edilir (`AllowP3Exception=true`).
