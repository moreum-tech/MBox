...
**Latest release:** [v0.4.0](https://github.com/moreum-tech/MBox/releases/tag/mstore-v0.4.0)

---

## Documentation

Full product documentation lives in [docs/](docs/README.md) — **nothing needs to be installed to read it**.
...
|------|----------|-------------|
| [mstore-linux-amd64.tar.gz](https://github.com/moreum-tech/MBox/releases/download/mstore-v0.4.0/mstore-linux-amd64.tar.gz) | Linux x86_64 | Server + CLI binary (`mstore-server`, `mstore`) |
| [mstore-windows-amd64.zip](https://github.com/moreum-tech/MBox/releases/download/mstore-v0.4.0/mstore-windows-amd64.zip) | Windows x86_64 | Server + CLI binary (`mstore-server.exe`, `mstore.exe`) |
| [mstore-docker.tar.gz](https://github.com/moreum-tech/MBox/releases/download/mstore-v0.4.0/mstore-docker.tar.gz) | Docker / Podman | OCI image (`docker load` / `podman load`) |
...
|-----------|-------------|---------|
| [Server](server/README.md) | S3 HTTP + gRPC endpoints | Installation, configuration |
