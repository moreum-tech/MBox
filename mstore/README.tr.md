...
**Son surum:** [v0.4.0](https://github.com/moreum-tech/MBox/releases/tag/mstore-v0.4.0)
...
|-------|----------|----------|
| [mstore-linux-amd64.tar.gz](https://github.com/moreum-tech/MBox/releases/download/mstore-v0.4.0/mstore-linux-amd64.tar.gz) | Linux x86_64 | Sunucu + CLI binary (`mstore-server`, `mstore`) |
| [mstore-windows-amd64.zip](https://github.com/moreum-tech/MBox/releases/download/mstore-v0.4.0/mstore-windows-amd64.zip) | Windows x86_64 | Sunucu + CLI binary (`mstore-server.exe`, `mstore.exe`) |
| [mstore-docker.tar.gz](https://github.com/moreum-tech/MBox/releases/download/mstore-v0.4.0/mstore-docker.tar.gz) | Docker / Podman | OCI imaji (`docker load` / `podman load`) |
