...
**Indir:** [mstore-docker.tar.gz](https://github.com/moreum-tech/MBox/releases/download/mstore-v0.4.0/mstore-docker.tar.gz) (v0.4.0) — OCI imaji, **Docker ve Podman** ile calisir
